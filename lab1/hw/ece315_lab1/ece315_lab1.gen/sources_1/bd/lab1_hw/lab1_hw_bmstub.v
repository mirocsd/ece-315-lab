...
module lab1_hw (
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 green_leds TRI_O" *)
  (* X_INTERFACE_MODE = "master green_leds" *)
  output [3:0]green_leds_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 rgb_led TRI_O" *)
  (* X_INTERFACE_MODE = "master rgb_led" *)
  output [2:0]rgb_led_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 buttons TRI_I" *)
  (* X_INTERFACE_MODE = "master buttons" *)
  input [3:0]buttons_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 switches TRI_I" *)
  (* X_INTERFACE_MODE = "master switches" *)
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 digit TRI_O" *)
  (* X_INTERFACE_MODE = "master digit" *)
  output [7:0]digit_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 keypad TRI_O" *)
  (* X_INTERFACE_MODE = "master keypad" *)
  output [7:0]keypad_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 keypad TRI_I" *)
  input [7:0]keypad_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 keypad TRI_T" *)
  output [7:0]keypad_tri_t;
